...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->comboBox1->Items->AddRange(gcnew cli::array< System::Object^  >(4) { L"Prekės pav.", L"Pirkėjo vardą", L"Kiekį", L"Kainą" });
			this->comboBox1->Location = System::Drawing::Point(302, 38);
			...
			this->name1->Location = System::Drawing::Point(13, 46);
			...
			this->label5->Text = L"Kaina";
			// 
			// button2
			// 
			this->button2->Font = (gcnew System::Drawing::Font(L"Consolas", 14));
			this->button2->Location = System::Drawing::Point(258, 207);
